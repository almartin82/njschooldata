...
A simple interface for accessing NJ DOE school data in **R and Python**. Part of the [state schooldata](https://github.com/almartin82/njschooldata) family of packages, originally the mothership package that inspired the 50-state effort.
