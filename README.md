...
Part of the [njschooldata](https://github.com/almartin82/njschooldata) family -- **this is the mothership package** that inspired the [state-schooldata project](https://github.com/almartin82/state-schooldata) now covering all 50 states.
