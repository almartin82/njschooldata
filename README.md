...
- [Staff History](https://almartin82.github.io/njschooldata/articles/nj-staff-history.html) -- summative educator evaluation rating distributions (2014-2016) and the deep certificated-staff FTE history (2000-2008, 2020-2026) via `fetch_staff_evaluations()` / `fetch_certificated_staff()`
...
- [Staff History](https://almartin82.github.io/njschooldata/articles/nj-staff-history.html) -- how concentrated teacher evaluation ratings are at the top of the scale and the long-run shape of the certificated workforce via `fetch_staff_evaluations()` / `fetch_certificated_staff()`
- [Getting Started](https://almartin82.github.io/njschooldata/articles/getting-started.html) -- installation, data fetching, and tidy format guide
