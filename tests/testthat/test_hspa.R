...
test_that("get_raw_hspa correctly grabs the 2014 HSPA", {
  ...
  expect_equal(nrow(ex_2014), 742)
  expect_equal(ncol(ex_2014), 558)
  expect_equal(sum(ex_2014$TOTAL_POPULATION_Number_Enrolled_LAL, na.rm = TRUE), 490677)
...
test_that("fetch_njask correctly grabs the 2007 HSPA", {
  ...
  expect_equal(ncol(fetch_07), 529)
