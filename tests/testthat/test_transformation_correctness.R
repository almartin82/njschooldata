...
test_that("grad_file_group_cleanup standardizes graduation subgroups", {
  ...
  expect_equal(result[15], "students with disabilities")
  expect_equal(result[16], "students with disabilities")
...
test_that("clean_grate_names standardizes pre-cohort graduation subgroups", {
  ...
  expect_equal(result[4], "limited english proficiency")
  expect_equal(result[5], "economically disadvantaged")
  expect_equal(result[6], "students with disabilities")
