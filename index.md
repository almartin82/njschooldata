...
| **Directory** | Current | [`fetch_directory()`](https://almartin82.github.io/njschooldata/reference/fetch_directory.md) | School and district entities (`entities`), role holders like superintendents (`roles`), fetch metadata (`meta`). Names, IDs, addresses, school type |
