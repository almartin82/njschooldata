...
ggplot(multi, aes(x = end_year, y = pct * 100)) +
  ...
  labs(title = "Multiracial Students: 2.4% to 3.5% of Enrollment",
       subtitle = "From 32,600 to 47,200 students since 2020, a 45% rise",
...
#> [29] curl_8.0.0         vctrs_0.7.3        R6_2.6.1           lifecycle_1.0.5   
...
#> [49] tidyselect_1.2.1   knitr_1.52         farver_2.1.2       htmltools_0.5.9   
#> [53] labeling_0.4.3     rmarkdown_2.32     readr_2.2.0        compiler_4.6.1    
#> [57] S7_0.2.2           readxl_1.5.0.1
```
