...
#> Rows: 101,650
#> Columns: 33
#> $ end_year                   <dbl> 2024, 2024, 2024, 2024, 2024, 2024, 2024, 2…
#> $ cds_code                   <chr> "010010999", "010010999", "010010999", "010…
#> $ county_id                  <chr> "01", "01", "01", "01", "01", "01", "01", "…
#> $ county_name                <chr> "Atlantic", "Atlantic", "Atlantic", "Atlant…
#> $ district_id                <chr> "0010", "0010", "0010", "0010", "0010", "00…
#> $ district_name              <chr> "Absecon Public Schools District", "Absecon…
#> $ school_id                  <chr> "999", "999", "999", "999", "999", "999", "…
#> $ school_name                <chr> "District Total", "District Total", "Distri…
#> $ program_code               <chr> "PH", NA, "PF", NA, "KH", NA, "KF", NA, "01…
#> $ program_name               <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ male                       <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ female                     <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ white                      <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ black                      <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ hispanic                   <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ asian                      <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ native_american            <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ pacific_islander           <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ multiracial                <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ row_total                  <dbl> 0.0, 0.0, 123.0, 13.3, 0.0, 0.0, 77.0, 8.3,…
#> $ free_lunch                 <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ reduced_lunch              <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ lep                        <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ migrant                    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ homeless                   <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ grade_level                <chr> "PK", NA, "PK", NA, "K", NA, "K", NA, "01",…
#> $ free_lunch_value_source    <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ reduced_lunch_value_source <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ lep_value_source           <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ migrant_value_source       <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ homeless_value_source      <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
#> $ nces_dist                  <chr> "3400660", "3400660", "3400660", "3400660",…
#> $ nces_sch                   <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
...
|----|----|----|
| Enrollment | [`fetch_enr()`](https://almartin82.github.io/njschooldata/reference/fetch_enr.md) | 1999-2026 |
| NJSLA/PARCC | [`fetch_parcc()`](https://almartin82.github.io/njschooldata/reference/fetch_parcc.md) | 2015-2019, 2022-2025 |
| NJASK | [`fetch_old_nj_assess()`](https://almartin82.github.io/njschooldata/reference/fetch_old_nj_assess.md) | 2004-2014 |
| Four-year Graduation Rates | [`fetch_grad_rate()`](https://almartin82.github.io/njschooldata/reference/fetch_grad_rate.md) | 2011-2025 |
| Graduation Counts | [`fetch_grad_count()`](https://almartin82.github.io/njschooldata/reference/fetch_grad_count.md) | 2012-2025 tidy; raw sources begin in 1998 |
...
#> [13] httr_1.4.9        codetools_0.2-20  textshaping_1.0.5 jquerylib_0.1.4  
#> [17] cli_3.6.6         crayon_1.5.3      rlang_1.3.0       bit64_4.8.6      
#> [21] withr_3.0.3       cachem_1.1.0      yaml_2.3.12       otel_0.2.0       
#> [25] parallel_4.6.1    tools_4.6.1       tzdb_0.5.0        curl_8.0.0       
