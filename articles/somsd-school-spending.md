...
#> [16] "CSG3"              "CSG4"              "CSG5"             
#> [19] "CSG6"              "CSG7"              "CSG8"             
#> [22] "CSG8A"             "CSG9"              "DETAIL_FY23"      
#> [25] "DETAIL_FY24"       "SUMMARY"           "SUMYR3"           
#> [28] "SUMYR3C"           "SUMYR4"            "SUMYR4C"          
#> [31] "SUMYR5"            "SUMYR5C"           "VITSTAT_TOTAL"    
...
# (both padded-NA forms: "00NA" on macOS, " NA" on Linux)
n_peers <- reports[["2025"]][["CSG1"]] %>%
  filter(group == "G. K-12 / 3501 +", end_year == 2025,
         !is.na(district_id),
         !grepl("^[0 ]*NA$", trimws(as.character(district_id)))) %>%
  nrow()
n_peers
#> [1] 100
...
#> [4] dplyr_1.2.1         ggplot2_4.0.3       njschooldata_0.9.26
#> 
...
#> [13] fastmap_1.2.0      cellranger_1.1.0   jsonlite_2.0.0     httr_1.4.9        
#> [17] codetools_0.2-20   textshaping_1.0.5  jquerylib_0.1.4    cli_3.6.6         
#> [21] crayon_1.5.3       rlang_1.3.0        bit64_4.8.6        withr_3.0.3       
#> [25] cachem_1.1.0       yaml_2.3.12        otel_0.2.0         parallel_4.6.1    
#> [29] tools_4.6.1        tzdb_0.5.0         curl_8.0.0         vctrs_0.7.3       
#> [33] R6_2.6.1           lifecycle_1.0.5    lubridate_1.9.5    snakecase_0.11.1  
#> [37] stringr_1.6.0      bit_4.6.0          fs_2.1.0           vroom_1.7.1       
#> [41] foreign_0.8-91     ragg_1.5.2         janitor_2.2.1      pkgconfig_2.0.3   
#> [45] desc_1.4.3         pkgdown_2.2.1      pillar_1.11.1      bslib_0.12.0      
#> [49] gtable_0.3.6       glue_1.8.1         systemfonts_1.3.2  xfun_0.61         
