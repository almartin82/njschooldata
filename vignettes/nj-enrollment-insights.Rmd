...
ggplot(top_10, aes(x = district_label, y = n_students)) +
  ...
  coord_flip() +
  scale_y_continuous(labels = comma) +
  labs(title = "Top 10 Districts Serve 20% of All Students",
       subtitle = "Just 10 out of 580+ districts educate one-fifth of NJ students",
       x = "", y = "Students") +
  theme_nj()
```
...
ggplot(multi, aes(x = end_year, y = pct * 100)) +
  ...
  labs(title = "Multiracial Students: Fastest-Growing Category",
       subtitle = "From 2.4% to 3.3% of enrollment in five years (37% growth)",
...
## 15. NJ's poverty gap: Passaic vs Princeton
