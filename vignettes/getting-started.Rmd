...
```{r legacy-assessment, eval = FALSE}
...
|-----------|----------|-----------------|
| Enrollment | `fetch_enr()` | 1999-2026 |
| NJSLA/PARCC | `fetch_parcc()` | 2015-2019, 2022-2025 |
| NJASK | `fetch_old_nj_assess()` | 2004-2014 |
| Four-year Graduation Rates | `fetch_grad_rate()` | 2011-2025 |
| Graduation Counts | `fetch_grad_count()` | 2012-2025 tidy; raw sources begin in 1998 |
...
**Note:** Special education data is available via `fetch_sped()`, not through enrollment subgroups.
...
- See `vignette("nj-enrollment-insights")` for 15 data stories with visualizations
- See `vignette("spr-dictionary")` for School Performance Report data
