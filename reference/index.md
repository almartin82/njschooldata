...
education, transportation, security, school choice, …) from the NJ DOE
Office of School Finance. The revenue-subsidy counterpart to the TGES
spending data.
...
- [`tges_excluded_costs()`](https://almartin82.github.io/njschooldata/reference/tges_excluded_costs.md)
  : What the budgetary per-pupil figure leaves out (incl. on-behalf TPAF
  pension)
...
- [`trim_whitespace()`](https://almartin82.github.io/njschooldata/reference/trim_whitespace.md)
  : Trim whitespace
- [`slugify_district()`](https://almartin82.github.io/njschooldata/reference/slugify_district.md)
