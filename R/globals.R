...
utils::globalVariables(c(
  ...
  "princ_title", "princ_first_name", "princ_last_name", "princ_title_2", "princ_email",
  "address2", "mailing_address1", "mailing_address2", "mailing_address3",
  "mailing_city", "mailing_state", "mailing_zip",
  "hib_title1", "hib_first_nname", "hib_first_name", "hib_last_name", "hib_title2",
  "homeless_liaison_title1", "homeless_liaison_first_name", "homeless_liaison_last_name",
  "homeless_liaison_title2",
  "pre_k", "kindergarten",
  "post_grad", "adult_ed", "nces_code",
  "supt_title", "supt_first_name", "supt_last_name", "supt_title_2", "supt_e_mail",
  "chrt_sch_code",
  "ba_title1", "ba_first_name", "ba_last_name", "ba_email", "ba_title2",
  "state_testing_coor_first_name", "state_testing_coor_last_name",
  "school_safety_specialist_first_name", "school_safety_specialist_last_name",
  "website", "nces_id", "entity_type",
  "principal_title", "principal_first_name", "principal_last_name",
  "principal_name", "principal_role", "principal_email",
  "superintendent_title", "superintendent_first_name", "superintendent_last_name",
  "superintendent_name", "superintendent_role", "superintendent_email",
  "ba_name", "ba_role",
  "hib_name", "hib_role", "homeless_liaison_name", "homeless_liaison_role",
  "testing_coordinator_name", "safety_specialist_name",
  "charter_school_code", "grades_served", "mailing_address", "phone",
  ...
  "state_sat", "state_act", "state_psat",
  "sat_school", "act_school", "psat_school",
  "sat_district", "act_district", "psat_district",
  "sat_state", "act_state", "psat_state",
  "sat", "act", "psat",
  ...
  "ap_3_ib_4_district",
  "average_score_school", "average_score_district", "average_score_state",
  "students_meeting_benchmark_school",
  "students_meeting_benchmark_district",
  "students_meeting_benchmark_state",
  "school_avg", "state_avg", "bt_pct", "state_bt_pct",
  "number_seals_earned", "percentage_seals_earned", "perc_12_graders",
  "has_ap", "has_ib",

  # ========== College & Career Readiness Columns ==========
  "ap_access_rate", "stem_participation_rate",
  "apib_course_school", "apib_course_district", "apib_course_state",
  "apib_coursework_school", "apib_coursework_state",
  "apib_exam_school", "apib_exam_district", "apib_exam_state",
  ...
  "cteparticipants_school", "cteparticipants_district", "cteparticipants_state",
  "cteconcentrators_school", "cteconcentrators_district",
  "cteconcentrators_state",
  ...
  "work_based_learning_count_school", "work_based_learning_count_district",
  "work_based_learning_count_state",
  "work_based_learning_pct_school", "work_based_learning_pct_district",
  ...
  # ========== Unified Course Front Door ==========
  "course_domain", "source_fetcher", "course_subject", "benchmark",
  "graduation_year", "apprenticeship_year", ".raw_value", ".metric_source",
  "metric", "polarity", "unit", "is_rate",
  "college_exam_avg_score_school", "college_exam_avg_score_district",
  "college_exam_avg_score_state",
  "college_exam_benchmark_school", "college_exam_benchmark_state",
